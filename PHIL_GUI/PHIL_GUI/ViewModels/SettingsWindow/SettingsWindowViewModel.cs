...
{
    /// <summary>
    /// ViewModel for the Settings window, managing application configuration pages.
    /// Provides navigation between settings categories (General and Developer) and saves changes.
    /// </summary>
    public class SettingsWindowViewModel : ViewModelBase
    {
        /// <summary>SVG path data for the Plate settings page icon.</summary>
        ...
        /// <summary>SVG path data for the Controls settings page icon.</summary>
        ...
        /// <summary>SVG path data for the Debug settings page icon.</summary>
        ...
        /// <summary>
        /// Gets or sets the command to cancel settings changes (currently not implemented).
        /// </summary>
        public ICommand CancelCommand { get; set; }

        /// <summary>
        /// Gets or sets the command to save all settings changes.
        /// </summary>
        ...
        /// <summary>
        /// Gets the list of general settings pages (Plate, Controls).
        /// </summary>
        public List<PageItem> GeneralPages { get; }

        /// <summary>
        /// Gets the list of developer settings pages (Debug).
        /// </summary>
        public List<PageItem> DeveloperPages { get; }

        /// <summary>
        /// Gets the combined list of all settings pages.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the current settings page ViewModel being displayed.
        /// </summary>
        ...
        /// Sets up the settings pages and commands.
        /// </summary>
        ...
        /// <summary>
        /// Saves all settings changes by calling ApplyChanges on each settings page and persisting to disk.
        /// </summary>
        private void Save()
        {
