...
{
    /// <summary>
    /// ViewModel for the main application window, managing page navigation and global robot commands.
    /// Provides access to well management, calibration, and medium exchange pages.
    /// </summary>
    public class MainWindowViewModel : ViewModelBase
    {
        /// <summary>SVG path data for the Wells page icon.</summary>
        ...
        /// <summary>SVG path data for the Calibration page icon.</summary>
        ...
        /// <summary>SVG path data for the Medium Exchange page icon.</summary>
        ...
        /// <summary>
        /// Event raised when the user disconnects from the robot.
        /// </summary>
        public Action Disconnected;

        /// <summary>
        /// Gets the command to disconnect from the robot and return to port selection.
        /// </summary>
        public ICommand DisconnectCommand { get; }

        /// <summary>
        /// Gets the command to move the robot up (Z-axis positive direction).
        /// </summary>
        public ICommand MoveUpCommand { get; }

        /// <summary>
        /// Gets the command to move the robot down (Z-axis negative direction).
        /// </summary>
        public ICommand MoveDownCommand { get; }

        /// <summary>
        /// Gets the command to move the robot to the home position.
        /// </summary>
        public ICommand GoHomeCommand { get; }

        /// <summary>
        /// Gets the command to calibrate the home position at the current robot location.
        /// </summary>
        public ICommand CalibrateHomeCommand { get; }

        /// <summary>
        /// Gets the command to trigger an emergency stop of all robot movement.
        /// </summary>
        public ICommand EmergencyStopCommand { get; }

        /// <summary>
        /// Gets the list of available pages (Wells, Calibration, Medium Exchange).
        /// </summary>
        public List<PageItem> Pages { get; }

        private PageItem selectedPage;
        /// <summary>
        /// Gets or sets the currently selected page tab.
        /// Automatically updates the CurrentPage property when changed.
        /// </summary>
        ...
        /// <summary>
        /// Gets the name of the serial port currently connected to the robot.
        /// </summary>
        public string ConnectedPort => RobotProtocolService.SerialPortService.PortName;

        private object currentPage;
        /// <summary>
        /// Gets or sets the current page ViewModel being displayed in the content area.
        /// </summary>
        ...
        /// <summary>
        /// Gets the current state of the robot's limit switches.
        /// </summary>
        ...
        /// Sets up page navigation, commands, and retrieves the connected port information.
        /// </summary>
        ...
        /// <summary>
        /// Disconnects from the robot and raises the Disconnected event to return to port selection.
        /// </summary>
